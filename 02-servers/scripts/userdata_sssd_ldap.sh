...
# Descriptive hostname for consistency. Note: this box does NOT join the domain,
# so (unlike the other two) it creates NO computer object in AD — that's the
# point of the ldap provider.
